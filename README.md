...
| `MAX_BOT_URL` | Ссылка на основного MAX-бота (показывается в `/help`) | `https://max.ru/id710708943262_bot` |
| `MAX_BOT_URL_RESERVE` | Ссылка на запасного MAX-бота (failover; пусто — скрыть подсказку) | `https://max.ru/id710708943262_4_bot` |
...
| `TG_MAX_FILE_SIZE_MB` | Дополнительный лимит файла из Telegram в MAX. Если не задан: документы — до 1 ГиБ, остальные медиа — до 512 МиБ | — |
